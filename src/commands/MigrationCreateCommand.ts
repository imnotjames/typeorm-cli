 ...
 */
export default class MigrationCreateCommand implements yargs.CommandModule {
...
export class ${CommandUtils.camelCase(name, true)}${timestamp} implements MigrationInterface {
